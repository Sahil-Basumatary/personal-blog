...
function CategoriesSection() {
  return (
    <section className="categories">
      ...
      <div className="cards">
        <div className="card">
          <Link to="/blog?category=cs-journey" className="category-card">
        ...
        <div className="card">
          <Link to="/blog?category=life-in-london" className="category-card">
        ...
        <div className="card">
          <Link to="/blog?category=motivation" className="category-card">
        ...
        <div className="card">
          <Link to="/blog?category=tools" className="category-card">
